...
const ContactUs = () => {
  ...
  const onSubmit = async (event) =>{
    ...
    formData.append("access_key", "1b14e54d-4feb-41b4-aa2a-5189771b07be");
  ...
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      ...
      <button type='submit' className='w-max flex gap-2 bg-primary text-wite text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-103 transition-all'>
