...
const Hero = () => {
  return (
    ...
    >
      <div className="inline-flex items-centr gap-2 border border-gray-300 p-1.5 pr-4 rounded-full">
      ...
      <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[95px] max-w-5xl">
        ...
        <span className="bg-gradient-to-r from-[#4539e7] to-[#5695f3] bg-clip-text text-transparent">
          digital{" "}
        </span>
        impact.
      </h1>
